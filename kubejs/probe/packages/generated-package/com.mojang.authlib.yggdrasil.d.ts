 ...
 * types for convenience unless there's a naming conflict.
 */
export type $AbuseReportRequest$RealmInfo$$Type = ({"realmId"?: StringJS, "slotId"?: integer}) | ([realmId?: StringJS, slotId?: integer]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $AbuseReportRequest$ClientInfo$$Type = ({"locale"?: StringJS, "clientVersion"?: StringJS}) | ([locale?: StringJS, clientVersion?: StringJS]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $KeyPairResponse$$Type = ({"keyPair"?: $KeyPairResponse$KeyPair$$Type, "expiresAt"?: StringJS, "publicKeySignature"?: $ByteBuffer$$Type, "refreshedAfter"?: StringJS}) | ([keyPair?: $KeyPairResponse$KeyPair$$Type, expiresAt?: StringJS, publicKeySignature?: $ByteBuffer$$Type, refreshedAfter?: StringJS]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
