 ...
 */
export type $AnimationPoint$$Type = ({"currentTick"?: double, "animationEndValue"?: double, "transitionLength"?: double, "animationStartValue"?: double, "keyFrame"?: $Keyframe$$Type<(never)>}) | ([currentTick?: double, animationEndValue?: double, transitionLength?: double, animationStartValue?: double, keyFrame?: $Keyframe$$Type<(never)>]);
/**
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $BoneAnimationQueue$$Type = ({"rotationYQueue"?: $AnimationPointQueue$$Type, "scaleYQueue"?: $AnimationPointQueue$$Type, "positionZQueue"?: $AnimationPointQueue$$Type, "positionXQueue"?: $AnimationPointQueue$$Type, "rotationZQueue"?: $AnimationPointQueue$$Type, "scaleZQueue"?: $AnimationPointQueue$$Type, "scaleXQueue"?: $AnimationPointQueue$$Type, "rotationXQueue"?: $AnimationPointQueue$$Type, "positionYQueue"?: $AnimationPointQueue$$Type, "bone"?: $GeoBone$$Type}) | ([rotationYQueue?: $AnimationPointQueue$$Type, scaleYQueue?: $AnimationPointQueue$$Type, positionZQueue?: $AnimationPointQueue$$Type, positionXQueue?: $AnimationPointQueue$$Type, rotationZQueue?: $AnimationPointQueue$$Type, scaleZQueue?: $AnimationPointQueue$$Type, scaleXQueue?: $AnimationPointQueue$$Type, rotationXQueue?: $AnimationPointQueue$$Type, positionYQueue?: $AnimationPointQueue$$Type, bone?: $GeoBone$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $Animation$$Type = ({"name"?: StringJS, "length"?: double, "keyFrames"?: $Animation$Keyframes$$Type, "loopType"?: $Animation$LoopType$$Type, "boneAnimations"?: ($BoneAnimation$$Type)[]}) | ([name?: StringJS, length?: double, keyFrames?: $Animation$Keyframes$$Type, loopType?: $Animation$LoopType$$Type, boneAnimations?: ($BoneAnimation$$Type)[]]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $KeyFrameData$$Original = $KeyFrameData;}
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $Keyframe$$Type<T> = ({"length"?: double, "startValue"?: T, "easingArgs"?: $List$$Type<(T)>, "easingType"?: $EasingType$$Type, "endValue"?: T}) | ([length?: double, startValue?: T, easingArgs?: $List$$Type<(T)>, easingType?: $EasingType$$Type, endValue?: T]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $BoneAnimation$$Type = ({"positionKeyFrames"?: $KeyframeStack$$Type<($Keyframe$$Type<($MathValue$$Type)>)>, "scaleKeyFrames"?: $KeyframeStack$$Type<($Keyframe$$Type<($MathValue$$Type)>)>, "boneName"?: StringJS, "rotationKeyFrames"?: $KeyframeStack$$Type<($Keyframe$$Type<($MathValue$$Type)>)>}) | ([positionKeyFrames?: $KeyframeStack$$Type<($Keyframe$$Type<($MathValue$$Type)>)>, scaleKeyFrames?: $KeyframeStack$$Type<($Keyframe$$Type<($MathValue$$Type)>)>, boneName?: StringJS, rotationKeyFrames?: $KeyframeStack$$Type<($Keyframe$$Type<($MathValue$$Type)>)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $Animation$Keyframes$$Type = ({"sounds"?: ($SoundKeyframeData$$Type)[], "particles"?: ($ParticleKeyframeData$$Type)[], "customInstructions"?: ($CustomInstructionKeyframeData$$Type)[]}) | ([sounds?: ($SoundKeyframeData$$Type)[], particles?: ($ParticleKeyframeData$$Type)[], customInstructions?: ($CustomInstructionKeyframeData$$Type)[]]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
