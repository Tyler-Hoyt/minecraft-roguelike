 ...
 * types for convenience unless there's a naming conflict.
 */
export type $CombatEntry$$Type = ({"fallDistance"?: float, "fallLocation"?: $FallLocation$$Type, "damage"?: float, "source"?: $DamageSource$$Type}) | ([fallDistance?: float, fallLocation?: $FallLocation$$Type, damage?: float, source?: $DamageSource$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $DamageType$$Type = (Special.DamageType) | ({"msgId"?: StringJS, "deathMessageType"?: $DeathMessageType$$Type, "exhaustion"?: float, "effects"?: $DamageEffects$$Type, "scaling"?: $DamageScaling$$Type}) | ([msgId?: StringJS, deathMessageType?: $DeathMessageType$$Type, exhaustion?: float, effects?: $DamageEffects$$Type, scaling?: $DamageScaling$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
