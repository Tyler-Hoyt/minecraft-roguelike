 ...
 */
export type $TypedOptic$Element$$Type<S, T, A, B> = ({"optic"?: $Optic$$Type<(never), (S), (T), (A), (B)>, "bType"?: $Type$$Type<(B)>, "aType"?: $Type$$Type<(A)>, "tType"?: $Type$$Type<(T)>, "sType"?: $Type$$Type<(S)>}) | ([optic?: $Optic$$Type<(never), (S), (T), (A), (B)>, bType?: $Type$$Type<(B)>, aType?: $Type$$Type<(A)>, tType?: $Type$$Type<(T)>, sType?: $Type$$Type<(S)>]);
/**
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $RewriteResult$$Type<A, B> = ({"recData"?: $BitSet$$Type, "view"?: $View$$Type<(A), (B)>}) | ([recData?: $BitSet$$Type, view?: $View$$Type<(A), (B)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
