 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ModLoadingIssue$$Type = ({"translationArgs"?: $List$$Type<(any)>, "severity"?: $ModLoadingIssue$Severity$$Type, "affectedModFile"?: $IModFile$$Type, "affectedPath"?: $Path$$Type, "affectedMod"?: $IModInfo$$Type, "cause"?: $Throwable$$Type, "translationKey"?: StringJS}) | ([translationArgs?: $List$$Type<(any)>, severity?: $ModLoadingIssue$Severity$$Type, affectedModFile?: $IModFile$$Type, affectedPath?: $Path$$Type, affectedMod?: $IModInfo$$Type, cause?: $Throwable$$Type, translationKey?: StringJS]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
