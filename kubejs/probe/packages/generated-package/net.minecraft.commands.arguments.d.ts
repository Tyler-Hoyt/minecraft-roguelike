...
public "getExamples"(): $Collection<(StringJS)>
public static "resolveKey"<T>(arg0: $CommandContext$$Type<($CommandSourceStack$$Type)>, arg1: StringJS, arg2: $ResourceKey$$Type<($Registry<(T)>)>, arg3: $DynamicCommandExceptionType$$Type): $Holder$Reference<(T)>
public "listSuggestions"<S>(arg0: $CommandContext$$Type<(S)>, arg1: $SuggestionsBuilder$$Type): $CompletableFuture<($Suggestions)>
