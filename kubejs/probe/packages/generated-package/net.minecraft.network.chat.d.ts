 ...
 * types for convenience unless there's a naming conflict.
 */
export type $SignedMessageLink$$Type = ({"sessionId"?: $UUID$$Type, "index"?: integer, "sender"?: $UUID$$Type}) | ([sessionId?: $UUID$$Type, index?: integer, sender?: $UUID$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $RemoteChatSession$Data$$Type = ({"sessionId"?: $UUID$$Type, "profilePublicKey"?: $ProfilePublicKey$Data$$Type}) | ([sessionId?: $UUID$$Type, profilePublicKey?: $ProfilePublicKey$Data$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $RemoteChatSession$$Type = ({"sessionId"?: $UUID$$Type, "profilePublicKey"?: $ProfilePublicKey$$Type}) | ([sessionId?: $UUID$$Type, profilePublicKey?: $ProfilePublicKey$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
