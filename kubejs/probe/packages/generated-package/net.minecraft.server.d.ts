 ...
 * types for convenience unless there's a naming conflict.
 */
export type $Services$$Type = ({"servicesKeySet"?: $ServicesKeySet$$Type, "sessionService"?: $MinecraftSessionService$$Type, "profileRepository"?: $GameProfileRepository$$Type, "profileCache"?: $GameProfileCache$$Type}) | ([servicesKeySet?: $ServicesKeySet$$Type, sessionService?: $MinecraftSessionService$$Type, profileRepository?: $GameProfileRepository$$Type, profileCache?: $GameProfileCache$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $WorldStem$$Type = ({"resourceManager"?: $CloseableResourceManager$$Type, "worldData"?: $WorldData$$Type, "registries"?: $LayeredRegistryAccess$$Type<($RegistryLayer$$Type)>, "dataPackResources"?: $ReloadableServerResources$$Type}) | ([resourceManager?: $CloseableResourceManager$$Type, worldData?: $WorldData$$Type, registries?: $LayeredRegistryAccess$$Type<($RegistryLayer$$Type)>, dataPackResources?: $ReloadableServerResources$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
...
export class $MinecraftServer extends $ReentrantBlockableEventLoop<($TickTask)> implements $ServerInfo$$Interface, $ChunkIOErrorReporter$$Interface, $CommandSource$$Interface, $AutoCloseable$$Interface, $MinecraftServerKJS$$Interface {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $WorldLoader$PackConfig$$Type = ({"initialDataConfig"?: $WorldDataConfiguration$$Type, "safeMode"?: boolean, "initMode"?: boolean, "packRepository"?: $PackRepository$$Type}) | ([initialDataConfig?: $WorldDataConfiguration$$Type, safeMode?: boolean, initMode?: boolean, packRepository?: $PackRepository$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
