 ...
 */
export type $ModFileDiscoveryAttributes$$Type = ({"locator"?: $IModFileCandidateLocator$$Type, "reader"?: $IModFileReader$$Type, "dependencyLocator"?: $IDependencyLocator$$Type, "parent"?: $IModFile$$Type}) | ([locator?: $IModFileCandidateLocator$$Type, reader?: $IModFileReader$$Type, dependencyLocator?: $IDependencyLocator$$Type, parent?: $IModFile$$Type]);
/**
