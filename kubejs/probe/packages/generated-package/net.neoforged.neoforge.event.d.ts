 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ModMismatchEvent$MismatchResolutionResult$$Type = ({"resolver"?: $ModContainer$$Type, "modid"?: StringJS, "versionDifference"?: $ModMismatchEvent$MismatchedVersionInfo$$Type}) | ([resolver?: $ModContainer$$Type, modid?: StringJS, versionDifference?: $ModMismatchEvent$MismatchedVersionInfo$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
