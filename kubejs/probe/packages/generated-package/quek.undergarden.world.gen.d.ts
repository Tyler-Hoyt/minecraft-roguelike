declare module "quek.undergarden.world.gen.feature.config.UtheriumCrystalConfiguration" {
...
export class $UtheriumCrystalConfiguration extends $Record implements $FeatureConfiguration$$Interface {
static readonly "CODEC": $Codec<($UtheriumCrystalConfiguration)>

constructor(clusterConfig: $ColumnFeatureConfiguration$$Type, crystalConfig: $LargeDripstoneConfiguration$$Type, crystalChance: float, ceilingCrystals: boolean)

public "equals"(arg0: any): boolean
public "toString"(): StringJS
public "hashCode"(): integer
public "ceilingCrystals"(): boolean
public "clusterConfig"(): $ColumnFeatureConfiguration
public "crystalConfig"(): $LargeDripstoneConfiguration
public "crystalChance"(): float
 ...
 */
export type $UtheriumCrystalConfiguration$$Type = ({"clusterConfig"?: $ColumnFeatureConfiguration$$Type, "crystalChance"?: float, "ceilingCrystals"?: boolean, "crystalConfig"?: $LargeDripstoneConfiguration$$Type}) | ([clusterConfig?: $ColumnFeatureConfiguration$$Type, crystalChance?: float, ceilingCrystals?: boolean, crystalConfig?: $LargeDripstoneConfiguration$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $UtheriumCrystalConfiguration$$Original = $UtheriumCrystalConfiguration;}
declare module "quek.undergarden.world.gen.feature.UGBlockBlobFeature" {
...
export class $UGBlockBlobFeature extends $Feature<($BlockStateConfiguration)> {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $UGBlockBlobFeature$$Type = ($UGBlockBlobFeature);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $UGBlockBlobFeature$$Original = $UGBlockBlobFeature;}
declare module "quek.undergarden.world.gen.feature.AncientRootFeature" {
import {$GeodeConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
import {$RandomFeatureConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.RandomFeatureConfiguration"
import {$HugeMushroomFeatureConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.HugeMushroomFeatureConfiguration"
import {$AncientRootConfiguration, $AncientRootConfiguration$$Type} from "quek.undergarden.world.gen.feature.config.AncientRootConfiguration"
import {$SimpleBlockConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.SimpleBlockConfiguration"
import {$DeltaFeatureConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.DeltaFeatureConfiguration"
import {$MultifaceGrowthConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.MultifaceGrowthConfiguration"
import {$LayerConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.LayerConfiguration"
...
export class $AncientRootFeature extends $Feature<($AncientRootConfiguration)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
...
constructor(arg0: $Codec$$Type<($AncientRootConfiguration$$Type)>)

public "place"(arg0: $FeaturePlaceContext$$Type<($AncientRootConfiguration$$Type)>): boolean
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $AncientRootFeature$$Type = ($AncientRootFeature);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $AncientRootFeature$$Original = $AncientRootFeature;}
declare module "quek.undergarden.world.gen.feature.config.AncientRootConfiguration" {
import {$Codec} from "com.mojang.serialization.Codec"
import {$ConfiguredFeature} from "net.minecraft.world.level.levelgen.feature.ConfiguredFeature"
import {$Stream} from "java.util.stream.Stream"
import {$FeatureConfiguration$$Interface} from "net.minecraft.world.level.levelgen.feature.configurations.FeatureConfiguration"
...
export class $AncientRootConfiguration extends $Record implements $FeatureConfiguration$$Interface {
static readonly "CODEC": $Codec<($AncientRootConfiguration)>

constructor(rogdoricProbability: integer)

public "equals"(arg0: any): boolean
public "toString"(): StringJS
public "hashCode"(): integer
public "rogdoricProbability"(): integer
public "getFeatures"(): $Stream<($ConfiguredFeature<(never), (never)>)>
get "features"(): $Stream<($ConfiguredFeature<(never), (never)>)>
}
/**
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $AncientRootConfiguration$$Type = ({"rogdoricProbability"?: integer}) | ([rogdoricProbability?: integer]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $AncientRootConfiguration$$Original = $AncientRootConfiguration;}
declare module "quek.undergarden.world.gen.feature.UtheriumCrystalFeature" {
import {$GeodeConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
import {$CountConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.CountConfiguration"
import {$RandomPatchConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.RandomPatchConfiguration"
import {$UtheriumCrystalConfiguration, $UtheriumCrystalConfiguration$$Type} from "quek.undergarden.world.gen.feature.config.UtheriumCrystalConfiguration"
import {$RandomFeatureConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.RandomFeatureConfiguration"
import {$HugeMushroomFeatureConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.HugeMushroomFeatureConfiguration"
import {$SimpleBlockConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.SimpleBlockConfiguration"
import {$DeltaFeatureConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.DeltaFeatureConfiguration"
...
export class $UtheriumCrystalFeature extends $Feature<($UtheriumCrystalConfiguration)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
...
constructor(arg0: $Codec$$Type<($UtheriumCrystalConfiguration$$Type)>)

public "place"(arg0: $FeaturePlaceContext$$Type<($UtheriumCrystalConfiguration$$Type)>): boolean
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $UtheriumCrystalFeature$$Type = ($UtheriumCrystalFeature);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $UtheriumCrystalFeature$$Original = $UtheriumCrystalFeature;}
declare module "quek.undergarden.world.gen.feature.UGDeltaFeature" {
import {$GeodeConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
import {$BonusChestFeature} from "net.minecraft.world.level.levelgen.feature.BonusChestFeature"
import {$NetherForestVegetationConfig} from "net.minecraft.world.level.levelgen.feature.configurations.NetherForestVegetationConfig"
import {$DeltaFeature} from "net.minecraft.world.level.levelgen.feature.DeltaFeature"
import {$OreConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.OreConfiguration"
import {$RandomBooleanFeatureConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.RandomBooleanFeatureConfiguration"
import {$CountConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.CountConfiguration"
import {$RandomPatchConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.RandomPatchConfiguration"
...
export class $UGDeltaFeature extends $DeltaFeature {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $UGDeltaFeature$$Type = ($UGDeltaFeature);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $UGDeltaFeature$$Original = $UGDeltaFeature;}
declare module "quek.undergarden.world.gen.structure.BiggerJigsawStructure" {
...
export class $BiggerJigsawStructure extends $Structure {
static readonly "CODEC": $MapCodec<($BiggerJigsawStructure)>
static readonly "DIRECT_CODEC": $Codec<($Structure)>

constructor(arg0: $Structure$StructureSettings$$Type, arg1: $Holder$$Type<($StructureTemplatePool)>, arg2: ($ResourceLocation$$Type)?, arg3: integer, arg4: $HeightProvider$$Type, arg5: ($Heightmap$Types$$Type)?, arg6: integer, arg7: $List$$Type<($PoolAliasBinding$$Type)>, arg8: $DimensionPadding$$Type, arg9: $LiquidSettings$$Type)
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $BiggerJigsawStructure$$Type = ($BiggerJigsawStructure);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $BiggerJigsawStructure$$Original = $BiggerJigsawStructure;}
declare module "quek.undergarden.world.gen.feature.GlitterkelpFeature" {
import {$GeodeConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
export class $GlitterkelpFeature extends $Feature<($NoneFeatureConfiguration)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $GlitterkelpFeature$$Type = ($GlitterkelpFeature);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $GlitterkelpFeature$$Original = $GlitterkelpFeature;}
declare module "quek.undergarden.world.gen.feature.DroopvineFeature" {
import {$GeodeConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
export class $DroopvineFeature extends $Feature<($NoneFeatureConfiguration)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $DroopvineFeature$$Type = ($DroopvineFeature);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $DroopvineFeature$$Original = $DroopvineFeature;}
declare module "quek.undergarden.world.gen.carver.UGCaveWorldCarver" {
...
export class $UGCaveWorldCarver extends $CaveWorldCarver {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $UGCaveWorldCarver$$Type = ($UGCaveWorldCarver);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $UGCaveWorldCarver$$Original = $UGCaveWorldCarver;}
declare module "quek.undergarden.world.gen.feature.IcePillarFeature" {
import {$GeodeConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
export class $IcePillarFeature extends $Feature<($NoneFeatureConfiguration)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $IcePillarFeature$$Type = ($IcePillarFeature);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $IcePillarFeature$$Original = $IcePillarFeature;}
declare module "quek.undergarden.world.gen.feature.SmogVentFeature" {
import {$GeodeConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
export class $SmogVentFeature extends $Feature<($NoneFeatureConfiguration)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $SmogVentFeature$$Type = ($SmogVentFeature);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $SmogVentFeature$$Original = $SmogVentFeature;}
