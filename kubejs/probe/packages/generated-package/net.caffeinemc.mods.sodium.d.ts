...
export interface $AnimatedTextureAccessor$$Interface {

(): $List$$Type<($SpriteContents$FrameInfo$$Type)>
get "frames"(): $List<($SpriteContents$FrameInfo)>
}

export class $AnimatedTextureAccessor implements $AnimatedTextureAccessor$$Interface {
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $AnimatedTextureAccessor$$Original = $AnimatedTextureAccessor;}
