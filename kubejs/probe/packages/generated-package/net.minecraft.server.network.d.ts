...
export class $ServerCommonPacketListenerImpl implements $ServerCommonPacketListener$$Interface {
...
export class $ServerGamePacketListenerImpl extends $ServerCommonPacketListenerImpl implements $ServerGamePacketListener$$Interface, $ServerPlayerConnection$$Interface, $TickablePacketListener$$Interface {
static readonly "LATENCY_CHECK_INTERVAL": integer
