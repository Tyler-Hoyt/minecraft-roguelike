...
import {$ServerGamePacketListenerImplAccessor$$Interface} from "com.aetherteam.aether.mixin.mixins.common.accessor.ServerGamePacketListenerImplAccessor"
...
export class $ServerGamePacketListenerImpl extends $ServerCommonPacketListenerImpl implements $ServerGamePacketListener$$Interface, $ServerPlayerConnection$$Interface, $TickablePacketListener$$Interface, $ServerGamePacketListenerImplAccessor$$Interface {
...
public "redirect$bin000$bettercombat$getStackInHand"(instance: $ServerPlayer$$Type, hand: $InteractionHand$$Type): $ItemStack
...
public "handler$cgm000$ftbquests$handleClientInformation"(packet: $ServerboundClientInformationPacket$$Type, ci: $CallbackInfo$$Type): void
...
public "aether$setAboveGroundVehicleTickCount"(arg0: integer): void
public "aether$setAboveGroundTickCount"(arg0: integer): void
