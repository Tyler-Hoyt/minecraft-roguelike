 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ModFileScanData$ClassData$$Type = ({"parent"?: $Type$$Type, "clazz"?: $Type$$Type, "interfaces"?: $Set$$Type<($Type$$Type)>}) | ([parent?: $Type$$Type, clazz?: $Type$$Type, interfaces?: $Set$$Type<($Type$$Type)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
