 ...
 * types for convenience unless there's a naming conflict.
 */
export type $Frame$$Type = ({"depth"?: integer, "returnValueConsumer"?: $CommandResultCallback$$Type, "frameControl"?: $Frame$FrameControl$$Type}) | ([depth?: integer, returnValueConsumer?: $CommandResultCallback$$Type, frameControl?: $Frame$FrameControl$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $CommandQueueEntry$$Type<T> = ({"action"?: $EntryAction$$Type<(T)>, "frame"?: $Frame$$Type}) | ([action?: $EntryAction$$Type<(T)>, frame?: $Frame$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
