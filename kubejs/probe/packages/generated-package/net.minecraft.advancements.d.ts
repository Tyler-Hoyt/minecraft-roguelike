 ...
 * types for convenience unless there's a naming conflict.
 */
export type $CriterionTrigger$Listener$$Type<T> = ({"trigger"?: T, "criterion"?: StringJS, "advancement"?: $AdvancementHolder$$Type}) | ([trigger?: T, criterion?: StringJS, advancement?: $AdvancementHolder$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
