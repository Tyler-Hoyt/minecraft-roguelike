 ...
 * @deprecated
 */
public "removeAll"(key: any): $ImmutableCollection
...
public "orderEntriesByValue"(valueComparator: $Comparator$$Type<(V)>): $ImmutableBiMap$Builder<(K), (V)>
public "buildOrThrow"(): $ImmutableBiMap<(K), (V)>
/**
 * 
 * @deprecated
 */
public "buildKeepingLast"(): $ImmutableMap
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
