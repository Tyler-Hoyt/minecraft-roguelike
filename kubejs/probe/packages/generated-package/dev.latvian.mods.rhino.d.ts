 ...
 * types for convenience unless there's a naming conflict.
 */
export type $RecordTypeInfo$Data$$Type = ({"components"?: ($RecordTypeInfo$Component$$Type)[], "defaultArguments"?: (any)[], "componentMap"?: $Map$$Type<(StringJS), ($RecordTypeInfo$Component$$Type)>}) | ([components?: ($RecordTypeInfo$Component$$Type)[], defaultArguments?: (any)[], componentMap?: $Map$$Type<(StringJS), ($RecordTypeInfo$Component$$Type)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $JSOptionalParam$$Type = ({"optional"?: boolean, "name"?: StringJS, "type"?: $TypeInfo$$Type}) | ([optional?: boolean, name?: StringJS, type?: $TypeInfo$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $RecordTypeInfo$Component$$Type = ({"type"?: $TypeInfo$$Type, "name"?: StringJS, "index"?: integer}) | ([type?: $TypeInfo$$Type, name?: StringJS, index?: integer]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $TypeWrapper$$Type<T> = ({"factory"?: $TypeWrapperFactory$$Type<(T)>, "validator"?: $TypeWrapperValidator$$Type, "target"?: $Class$$Type<(T)>}) | ([factory?: $TypeWrapperFactory$$Type<(T)>, validator?: $TypeWrapperValidator$$Type, target?: $Class$$Type<(T)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
