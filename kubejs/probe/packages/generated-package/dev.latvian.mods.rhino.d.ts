 ...
 * types for convenience unless there's a naming conflict.
 */
export type $RecordTypeInfo$Component$$Type = ({"name"?: StringJS, "index"?: integer, "type"?: $TypeInfo$$Type}) | ([name?: StringJS, index?: integer, type?: $TypeInfo$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $TypeWrapper$$Type<T> = ({"validator"?: $TypeWrapperValidator$$Type, "target"?: $Class$$Type<(T)>, "factory"?: $TypeWrapperFactory$$Type<(T)>}) | ([validator?: $TypeWrapperValidator$$Type, target?: $Class$$Type<(T)>, factory?: $TypeWrapperFactory$$Type<(T)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $RecordTypeInfo$Data$$Type = ({"defaultArguments"?: (any)[], "componentMap"?: $Map$$Type<(StringJS), ($RecordTypeInfo$Component$$Type)>, "components"?: ($RecordTypeInfo$Component$$Type)[]}) | ([defaultArguments?: (any)[], componentMap?: $Map$$Type<(StringJS), ($RecordTypeInfo$Component$$Type)>, components?: ($RecordTypeInfo$Component$$Type)[]]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $JSOptionalParam$$Type = ({"name"?: StringJS, "type"?: $TypeInfo$$Type, "optional"?: boolean}) | ([name?: StringJS, type?: $TypeInfo$$Type, optional?: boolean]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $CachedParameters$$Type = ({"typeInfos"?: $List$$Type<($TypeInfo$$Type)>, "varArgType"?: $TypeInfo$$Type, "types"?: $List$$Type<($Class$$Type<(never)>)>, "count"?: integer, "firstArgContext"?: boolean}) | ([typeInfos?: $List$$Type<($TypeInfo$$Type)>, varArgType?: $TypeInfo$$Type, types?: $List$$Type<($Class$$Type<(never)>)>, count?: integer, firstArgContext?: boolean]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
