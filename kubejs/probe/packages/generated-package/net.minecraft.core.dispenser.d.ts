 ...
 */
export type $BlockSource$$Type = ({"state"?: $BlockState$$Type, "blockEntity"?: $DispenserBlockEntity$$Type, "pos"?: $BlockPos$$Type, "level"?: $ServerLevel$$Type}) | ([state?: $BlockState$$Type, blockEntity?: $DispenserBlockEntity$$Type, pos?: $BlockPos$$Type, level?: $ServerLevel$$Type]);
/**
