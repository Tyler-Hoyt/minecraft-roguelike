 ...
 * types for convenience unless there's a naming conflict.
 */
export type $GameConfig$QuickPlayData$$Type = ({"singleplayer"?: StringJS, "path"?: StringJS, "realms"?: StringJS, "multiplayer"?: StringJS}) | ([singleplayer?: StringJS, path?: StringJS, realms?: StringJS, multiplayer?: StringJS]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
