...
import {$IntFunction$$Type} from "java.util.function.IntFunction"
import {$IntConsumer$$Type as $IntConsumer$0$$Type} from "java.util.function.IntConsumer"
import {$IntUnaryOperator$$Type as $IntUnaryOperator$0$$Type} from "it.unimi.dsi.fastutil.ints.IntUnaryOperator"
import {$Stream} from "java.util.stream.Stream"
...
export class $AbstractLongCollection extends $AbstractCollection<(long)> implements $LongCollection$$Interface {
/**
 * 
 * @deprecated
 */
 ...
 * @deprecated
 */
public "removeIf"(arg0: $Predicate$$Type<(long)>): boolean
/**
 * 
 * @deprecated
 */
 ...
 * @deprecated
 */
public "forEach"(arg0: $Consumer$$Type<(long)>): void
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $AbstractLongCollection$$Original = $AbstractLongCollection;}
