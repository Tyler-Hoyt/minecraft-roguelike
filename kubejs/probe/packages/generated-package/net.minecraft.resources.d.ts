 ...
 * types for convenience unless there's a naming conflict.
 */
export type $RegistryOps$RegistryInfo$$Type<T> = ({"owner"?: $HolderOwner$$Type<(T)>, "elementsLifecycle"?: $Lifecycle$$Type, "getter"?: $HolderGetter$$Type<(T)>}) | ([owner?: $HolderOwner$$Type<(T)>, elementsLifecycle?: $Lifecycle$$Type, getter?: $HolderGetter$$Type<(T)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
...
export class $DelegatingOps<T> implements $DynamicOps$$Interface<(T)>, $ForwardingDynamicOpsAccessor$$Interface, $DelegatingOpsAccessor$$Interface {
