...
public "serializeNBT"(arg0: $HolderLookup$Provider$$Type): $ListTag
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $BiomeModifiers$AddFeaturesBiomeModifier$$Type = ({"biomes"?: $HolderSet$$Type<($Biome)>, "features"?: $HolderSet$$Type<($PlacedFeature)>, "step"?: $GenerationStep$Decoration$$Type}) | ([biomes?: $HolderSet$$Type<($Biome)>, features?: $HolderSet$$Type<($PlacedFeature)>, step?: $GenerationStep$Decoration$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ModifiableBiomeInfo$BiomeInfo$$Type = ({"climateSettings"?: $Biome$ClimateSettings$$Type, "mobSpawnSettings"?: $MobSpawnSettings$$Type, "generationSettings"?: $BiomeGenerationSettings$$Type, "effects"?: $BiomeSpecialEffects$$Type}) | ([climateSettings?: $Biome$ClimateSettings$$Type, mobSpawnSettings?: $MobSpawnSettings$$Type, generationSettings?: $BiomeGenerationSettings$$Type, effects?: $BiomeSpecialEffects$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
