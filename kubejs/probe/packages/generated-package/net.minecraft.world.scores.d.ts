 ...
 * types for convenience unless there's a naming conflict.
 */
export type $PlayerScoreEntry$$Type = ({"numberFormatOverride"?: $NumberFormat$$Type, "owner"?: StringJS, "display"?: $Component$$Type, "value"?: integer}) | ([numberFormatOverride?: $NumberFormat$$Type, owner?: StringJS, display?: $Component$$Type, value?: integer]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
