 ...
 */
 "probejsInternal$$Literal": Special.RepurposedStructuresJsonConditions
/**
 * This field is a type stub generated by ProbeJS and shall not be used in any sense.
 */
 "probejsInternal$$Tag": Special.RepurposedStructuresJsonConditionsTag
}
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $Supplier$$Type<T> = (Special.RepurposedStructuresJsonConditions) | (() => T);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
export interface $ToLongBiFunction$$Interface<T, U> {

(arg0: T, arg1: U): long
}

export class $ToLongBiFunction<T, U> implements $ToLongBiFunction$$Interface {
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $ToLongBiFunction$$Original<T, U> = $ToLongBiFunction<(T), (U)>;}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
export interface $ToDoubleBiFunction$$Interface<T, U> {

(arg0: T, arg1: U): double
}

export class $ToDoubleBiFunction<T, U> implements $ToDoubleBiFunction$$Interface {
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $ToDoubleBiFunction$$Original<T, U> = $ToDoubleBiFunction<(T), (U)>;}
