 ...
 */
export type $Registry$$Type<T> = (("minecraft:sensor_type") | ("neoforge:biome_modifier_serializers") | ("minecraft:worldgen/trunk_placer_type") | ("minecraft:worldgen/structure_placement") | ("minecraft:activity") | ("moonlight:world_saved_data_type") | ("minecraft:block_predicate_type") | ("minecraft:worldgen/flat_level_generator_preset") | ("moonlight:custom_map_data_types") | ("minecraft:worldgen/structure_set") | ("minecraft:rule_block_entity_modifier") | ("minecraft:worldgen/block_state_provider_type") | ("minecraft:worldgen/noise") | ("minecraft:decorated_pot_pattern") | ("minecraft:chat_type") | ("minecraft:loot_number_provider_type") | ("minecraft:schedule") | ("minecraft:villager_type") | ("minecraft:frog_variant") | ("minecraft:worldgen/world_preset") | ("minecraft:worldgen/structure_pool_element") | ("neoforge:structure_modifier") | ("minecraft:armor_material") | ("minecraft:creative_mode_tab") | ("minecraft:height_provider_type") | ("minecraft:float_provider_type") | ("minecraft:mob_effect") | ("minecraft:worldgen/noise_settings") | ("minecraft:rule_test") | ("minecraft:block") | ("minecraft:sound_event") | ("moonlight:map_marker") | ("minecraft:potion") | ("minecraft:entity_sub_predicate_type") | ("minecraft:worldgen/root_placer_type") | ("minecraft:enchantment_location_based_effect_type") | ("minecraft:worldgen/processor_list") | ("minecraft:worldgen/material_condition") | ("minecraft:worldgen/biome") | ("minecraft:worldgen/placement_modifier_type") | ("minecraft:worldgen/configured_carver") | ("minecraft:trim_pattern") | ("minecraft:worldgen/carver") | ("minecraft:loot_condition_type") | ("minecraft:worldgen/structure_processor") | ("minecraft:command_argument_type") | ("minecraft:enchantment_provider") | ("minecraft:item_sub_predicate_type") | ("minecraft:painting_variant") | ("moonlight:villager_trades") | ("neoforge:structure_modifier_serializers") | ("minecraft:cat_variant") | ("minecraft:enchantment_value_effect_type") | ("minecraft:enchantment_effect_component_type") | ("minecraft:memory_module_type") | ("minecraft:worldgen/structure_type") | ("moonlight:soft_fluid") | ("minecraft:loot_nbt_provider_type") | ("minecraft:trim_material") | ("minecraft:worldgen/biome_source") | ("minecraft:chunk_status") | ("minecraft:worldgen/placed_feature") | ("minecraft:worldgen/feature") | ("neoforge:global_loot_modifier_serializers") | ("minecraft:fluid") | ("minecraft:enchantment") | ("minecraft:enchantment_entity_effect_type") | ("minecraft:recipe_serializer") | ("minecraft:worldgen/multi_noise_biome_source_parameter_list") | ("minecraft:enchantment_provider_type") | ("minecraft:wolf_variant") | ("minecraft:banner_pattern") | ("minecraft:worldgen/chunk_generator") | ("minecraft:worldgen/configured_feature") | ("minecraft:worldgen/tree_decorator_type") | ("minecraft:loot_function_type") | ("minecraft:particle_type") | ("minecraft:villager_profession") | ("minecraft:worldgen/structure_piece") | ("minecraft:jukebox_song") | ("minecraft:game_event") | ("minecraft:block_entity_type") | ("minecraft:damage_type") | ("minecraft:trigger_type") | ("neoforge:fluid_ingredient_type") | ("minecraft:worldgen/template_pool") | ("minecraft:recipe_type") | ("minecraft:attribute") | ("minecraft:entity_type") | ("minecraft:worldgen/feature_size_type") | ("minecraft:worldgen/density_function_type") | ("neoforge:entity_data_serializers") | ("minecraft:pos_rule_test") | ("neoforge:holder_set_type") | ("minecraft:dimension_type") | ("minecraft:position_source_type") | ("minecraft:data_component_type") | ("minecraft:worldgen/structure") | ("minecraft:block_type") | ("minecraft:point_of_interest_type") | ("minecraft:worldgen/density_function") | ("minecraft:loot_score_provider_type") | ("minecraft:int_provider_type") | ("minecraft:menu") | ("neoforge:condition_codecs") | ("minecraft:map_decoration_type") | ("neoforge:ingredient_serializer") | ("minecraft:worldgen/pool_alias_binding") | ("minecraft:instrument") | ("minecraft:worldgen/material_rule") | ("minecraft:enchantment_level_based_value_type") | ("minecraft:worldgen/foliage_placer_type") | ("minecraft:item") | ("neoforge:fluid_type") | ("minecraft:loot_pool_entry_type") | ("minecraft:dimension") | ("neoforge:attachment_types") | ("neoforge:biome_modifier") | ("minecraft:stat_type") | ("minecraft:number_format_type"));
/**
...
public "west"(arg0: integer): $BlockPos
...
export class $Holder$Reference<T> implements $Holder$$Interface<(T)> {
