...
function tags(extra: "twilight:magic_paintings", handler: (event: $TagEventProbe<(Special.TwilightMagicPaintingsTag), (Special.TwilightMagicPaintings)>) => void): void
...
function tags(extra: "twilight:chunk_blanket_processors", handler: (event: $TagEventProbe<(Special.TwilightChunkBlanketProcessorsTag), (Special.TwilightChunkBlanketProcessors)>) => void): void
...
function tags(extra: "twilight:biome_layer_stack", handler: (event: $TagEventProbe<(Special.TwilightBiomeLayerStackTag), (Special.TwilightBiomeLayerStack)>) => void): void
...
function tags(extra: "twilight:biome_terrain_data", handler: (event: $TagEventProbe<(Special.TwilightBiomeTerrainDataTag), (Special.TwilightBiomeTerrainData)>) => void): void
...
function tags(extra: "malum:spirit_types", handler: (event: $TagEventProbe<(Special.MalumSpiritTypesTag), (Special.MalumSpiritTypes)>) => void): void
function tags(extra: "sound_event", handler: (event: $TagEventProbe<(Special.SoundEventTag), (Special.SoundEvent)>) => void): void
function tags(extra: "twilight:structure_speleothem_settings", handler: (event: $TagEventProbe<(Special.TwilightStructureSpeleothemSettingsTag), (Special.TwilightStructureSpeleothemSettings)>) => void): void
...
function tags(extra: "paraglider:bargain_preview_type", handler: (event: $TagEventProbe<(Special.ParagliderBargainPreviewTypeTag), (Special.ParagliderBargainPreviewType)>) => void): void
...
function tags(extra: "malum:spirit_rite_types", handler: (event: $TagEventProbe<(Special.MalumSpiritRiteTypesTag), (Special.MalumSpiritRiteTypes)>) => void): void
...
function tags(extra: "paraglider:wind_sources", handler: (event: $TagEventProbe<(Special.ParagliderWindSourcesTag), (Special.ParagliderWindSources)>) => void): void
function tags(extra: "malum:rite_effect_types", handler: (event: $TagEventProbe<(Special.MalumRiteEffectTypesTag), (Special.MalumRiteEffectTypes)>) => void): void
...
function tags(extra: "paraglider:bargain_types", handler: (event: $TagEventProbe<(Special.ParagliderBargainTypesTag), (Special.ParagliderBargainTypes)>) => void): void
...
function tags(extra: "twilight:biome_layer_type", handler: (event: $TagEventProbe<(Special.TwilightBiomeLayerTypeTag), (Special.TwilightBiomeLayerType)>) => void): void
...
function tags(extra: "twilight:template_marker_handler", handler: (event: $TagEventProbe<(Special.TwilightTemplateMarkerHandlerTag), (Special.TwilightTemplateMarkerHandler)>) => void): void
...
function tags(extra: "twilight:travellers_modifiers", handler: (event: $TagEventProbe<(Special.TwilightTravellersModifiersTag), (Special.TwilightTravellersModifiers)>) => void): void
...
function tags(extra: "twilightforest:template_marker_handler_type", handler: (event: $TagEventProbe<(Special.TwilightforestTemplateMarkerHandlerTypeTag), (Special.TwilightforestTemplateMarkerHandlerType)>) => void): void
...
function tags(extra: "twilight:travellers_modifier_type", handler: (event: $TagEventProbe<(Special.TwilightTravellersModifierTypeTag), (Special.TwilightTravellersModifierType)>) => void): void
...
function tags(extra: "twilight:wood_palettes", handler: (event: $TagEventProbe<(Special.TwilightWoodPalettesTag), (Special.TwilightWoodPalettes)>) => void): void
...
function tags(extra: "twilight:template_marker_handler_list", handler: (event: $TagEventProbe<(Special.TwilightTemplateMarkerHandlerListTag), (Special.TwilightTemplateMarkerHandlerList)>) => void): void
...
function tags(extra: "twilight:dwarf_rabbit_variant", handler: (event: $TagEventProbe<(Special.TwilightDwarfRabbitVariantTag), (Special.TwilightDwarfRabbitVariant)>) => void): void
...
function tags(extra: "twilightforest:chunk_blanket_type", handler: (event: $TagEventProbe<(Special.TwilightforestChunkBlanketTypeTag), (Special.TwilightforestChunkBlanketType)>) => void): void
function tags(extra: "repurposed_structures:json_conditions", handler: (event: $TagEventProbe<(Special.RepurposedStructuresJsonConditionsTag), (Special.RepurposedStructuresJsonConditions)>) => void): void
...
function tags(extra: "twilight:restrictions", handler: (event: $TagEventProbe<(Special.TwilightRestrictionsTag), (Special.TwilightRestrictions)>) => void): void
...
function tags(extra: "twilightforest:enforcement", handler: (event: $TagEventProbe<(Special.TwilightforestEnforcementTag), (Special.TwilightforestEnforcement)>) => void): void
...
function tags(extra: "twilight:tiny_bird_variant", handler: (event: $TagEventProbe<(Special.TwilightTinyBirdVariantTag), (Special.TwilightTinyBirdVariant)>) => void): void
...
function tags(extra: "twilight:item_display_type", handler: (event: $TagEventProbe<(Special.TwilightItemDisplayTypeTag), (Special.TwilightItemDisplayType)>) => void): void
